...
const ExpertsSection = () => {
  ...
  return (
    <section className="w-full bg-white py-24 sm:py-32 relative overflow-hidden">
      ...
      <svg className="absolute top-40 left-0 w-full h-[600px] text-[#f4f7f0] pointer-events-none z-0" preserveAspectRatio="none" viewBox="0 0 1440 600" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="max-w-[1100px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-16 sm:mb-20">
          ...
          <p className="text-gray-600 text-lg leading-relaxed">
            At the heart of our work is a team of experienced engineers, architects, and developers who bring clarity, insight, and direction to every project.
          </p>
        </div>

        {/* Cards Grid - 2 cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-[800px] mx-auto mb-20">
          {experts.map((expert, idx) => (
            ...
            >
              <div className="bg-[#f2f1eb] rounded-[20px] p-6 h-full flex flex-col border border-gray-200/50 shadow-[inset_0_2px_10px_rgba(0,0,0,0.02)]">
                {/* Image */}
                <img src={expert.image} alt={expert.name} className="w-full h-[300px] object-cover rounded-xl mb-6 shadow-sm" />
