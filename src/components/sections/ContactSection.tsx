      ...
      <div className="max-w-350 mx-auto px-4 pt-0 sm:pt-0 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            ...
            <button
              onClick={() => navigate("/contact")}
              className="flex items-center gap-2 bg-brand-light text-[#0f291e] px-6 py-4 rounded-2xl border border-gray-200 font-bold text-xs hover:bg-[#e2ead9] transition-all"
            >
              Our Services
